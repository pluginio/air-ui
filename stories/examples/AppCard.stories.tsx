...
export const AppCard = () => {
  ...
  <Flex bgColor={isDark ? "#22272C" : "gray.200"} borderStartRadius="22px" borderEndRadius="10px" lineHeight="none" h="114px" maxW="320px" mb="4">
    <Image width="114px" height="114px" src="https://raw.githubusercontent.com/pluginio/static-content/main/lang/en/docs/v1/images/cut_the_rope_2_icon.webp" alt="cut the rope 2" borderRadius="22px"/>
